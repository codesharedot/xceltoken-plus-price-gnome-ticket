#!/usr/bin/env python
# rename to xceltoken-plus.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/xceltoken-plus/")
...
print("xceltoken-plus $" + str(usd) + " | iconName=invest-applet")
print("---")
