#!/usr/bin/env python
# rename to bit-z-token.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/bit-z-token/")
...
print("bit-z-token $" + str(usd) + " | iconName=invest-applet")
print("---")
