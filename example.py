#!/usr/bin/env python
# rename to mixin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/mixin/")
...
print("mixin $" + str(usd) + " | iconName=invest-applet")
print("---")
