#!/usr/bin/env python
# rename to mexc-token.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/mexc-token/")
...
print("mexc-token $" + str(usd) + " | iconName=invest-applet")
print("---")
