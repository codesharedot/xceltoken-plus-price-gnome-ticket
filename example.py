#!/usr/bin/env python
# rename to ftx-token.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/ftx-token/")
...
print("ftx-token $" + str(usd) + " | iconName=invest-applet")
print("---")
