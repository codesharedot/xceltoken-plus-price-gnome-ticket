#!/usr/bin/env python
# rename to mx-token.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/mx-token/")
...
print("mx-token $" + str(usd) + " | iconName=invest-applet")
print("---")
