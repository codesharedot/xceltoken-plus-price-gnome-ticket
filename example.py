#!/usr/bin/env python
# rename to bitcoin2.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/bitcoin2/")
...
print("bitcoin2 $" + str(usd) + " | iconName=invest-applet")
print("---")
