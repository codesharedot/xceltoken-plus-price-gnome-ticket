#!/usr/bin/env python
# rename to ino-coin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/ino-coin/")
...
print("ino-coin $" + str(usd) + " | iconName=invest-applet")
print("---")
