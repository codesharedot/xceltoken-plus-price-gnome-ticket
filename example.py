#!/usr/bin/env python
# rename to mb8-coin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/mb8-coin/")
...
print("mb8-coin $" + str(usd) + " | iconName=invest-applet")
print("---")
