#!/usr/bin/env python
# rename to flexacoin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/flexacoin/")
...
print("flexacoin $" + str(usd) + " | iconName=invest-applet")
print("---")
