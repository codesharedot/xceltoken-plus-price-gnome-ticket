#!/usr/bin/env python
# rename to insight-chain.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/insight-chain/")
...
print("insight-chain $" + str(usd) + " | iconName=invest-applet")
print("---")
