#!/usr/bin/env python
# rename to ecoreal-estate.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/ecoreal-estate/")
...
print("ecoreal-estate $" + str(usd) + " | iconName=invest-applet")
print("---")
