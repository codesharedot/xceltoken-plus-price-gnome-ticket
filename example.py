#!/usr/bin/env python
# rename to oasis-city.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/oasis-city/")
...
print("oasis-city $" + str(usd) + " | iconName=invest-applet")
print("---")
