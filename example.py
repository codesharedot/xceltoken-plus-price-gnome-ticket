#!/usr/bin/env python
# rename to clipper-coin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/clipper-coin/")
...
print("clipper-coin $" + str(usd) + " | iconName=invest-applet")
print("---")
